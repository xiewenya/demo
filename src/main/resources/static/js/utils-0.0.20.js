    ...
    var window = function () {
        var inner = function (options, context) {
            ...
            this.defaults = {
                ...
                draggable: true,
                draggableScript: 'statics.js/jquery-ui-1.12.0-draggable.min.statics.js', // relative to context
...
function init_markdown_converter() {
    ...
    $('[data-markdown]').each(function () {
        var $that = $(this);
        $.script.loadScript('statics.js/xss-0.2.16.min.statics.js').done(function () {
            $.script.loadScript('statics.js/showdown-1.4.2.min.statics.js').done(function () {
